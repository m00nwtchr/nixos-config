{
  ...
  hardware.ppd-auto = {
    nixos = {
      ...
      cfg = config.services.m00n.ppd-auto;
    in {
      options.services.m00n.ppd-auto = {
      ...
      config = lib.mkIf cfg.enable {
        ...
        systemd.services."powerprofile-set@" = {
          ...
          serviceConfig = {
            ...
            ExecStart = let
              script = pkgs.writeShellScript "powerprofile-set-instance" ''
                set -euo pipefail
                want="$1"
        ...
        systemd.services.powerprofile-decide-on-battery = let
          decideScript = pkgs.writeShellScript "powerprofile-decide" ''
            set -euo pipefail
